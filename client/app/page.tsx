...
export default function HomePage() {
  ...
  const handleMainContentTransitionEnd = () => {
  ...
  return (
    <>
      ...
      <div
        ...
        className={`min-h-screen relative overflow-hidden transition-all duration-1000 ease-in-out z-10 ${
          !isLoading ? "translate-y-0 opacity-100" : "translate-y-full opacity-100"
        }`}
        style={{
          transform: !isLoading ? "translateY(0) rotateX(0deg)" : "translateY(100%) rotateX(-10deg)",
      ...
      >
            ...
            >
              ...
              <g>
                ...
                <circle
                  ...
                  opacity="1"
                  filter="url(#neonGlow)"
                  style={{ animationPlayState: animationsStarted ? "running" : "paused" }}
                >
        ...
        <header className="relative z-10 flex items-center justify-between px-4 sm:px-6 py-4 lg:px-12">
          <div className="flex items-center space-x-2 pl-3 sm:pl-6 lg:pl-12">
            <img src="/logo-orng.svg" alt="Logo" className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12" />
          </div>
